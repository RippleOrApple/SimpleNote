...
- V2 Phase 2 已推进到 Task 20：任务时间、重复任务、完成事件、日期查询、日历聚合、提醒调度接口和任务详情提醒控件。
...
- [开发阶段计划](docs/DEVELOPMENT_PHASES.md)
- [V1 项目总结](docs/V1_PROJECT_SUMMARY.md)
- [V2 Phase 1 验收记录](docs/V2_PHASE_1_ACCEPTANCE.md)
...
- V2 Phase 2 后续日历 UI 或通知权限/原生通知接入。
- V2 Phase 3：习惯与统计。
